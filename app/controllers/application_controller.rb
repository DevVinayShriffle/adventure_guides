class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    # devise_parameter_sanitizer.permit(:account_update, keys: %i[name phone avatar])
    devise_parameter_sanitizer.permit(:account_update, keys: [:name, :phone, :avatar, :password])
  end
